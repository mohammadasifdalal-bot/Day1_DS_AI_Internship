...
# 1️⃣ Create a heavily right-skewed dataset (like income)
population = np.random.exponential(scale=50000, size=100000)

# 2️⃣ Take 1000 samples of size 30 and compute their means
sample_means = []
...
# 3️⃣ Plot Original Data vs Distribution of Sample Means
...
# 4️⃣ Print  insight comparison statistics
